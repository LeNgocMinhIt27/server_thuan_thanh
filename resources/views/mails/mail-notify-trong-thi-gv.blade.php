                        ...
                        <tr>
                          <td align="center" class="container-padding">
                            ...
                            <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                              <tr>
                                <td align="left" class="center-text"></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                  ...
                  <tr>
                    <td align="center">
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                        <tr>
                          <td align="left" style="border-radius: 6px;color:#FFFFFF;padding-bottom:12px"> Giảng viên: {{$user_data['name']}}</td>
                        </tr>
                        @foreach ($data_info as $item)
                        <tr>
                            <td style="padding-bottom: 12px;">
                                <table style="border:solid 1px #fff;padding:24px;width:100%;border-radius:12px" border="0" cellspacing="0" cellpadding="0" role="presentation" align="left">
                                    <tr>
                                        <td align="left" style="border-radius: 6px; color: #FFFFFF; padding-bottom: 10px"> Ngày thi: {{\Carbon\Carbon::parse($item['ngay_thi'] ?? '')->format('d/m/Y')}}</td>
                                    </tr>
                                    <tr>
                                        <td align="left" style="border-radius: 6px; color: #FFFFFF; padding-bottom: 10px"> Kíp thi: {{$item['kip_thi'] ?? ''}}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    @endforeach
                        <tr>
                          <td align="center" style="border-radius: 6px;color:#FFFFFF"> Lưu ý: Đến trước giờ thi 20 phút để nhận thông tin về phòng thi. </td>
                        </tr>
                        <tr>
                          <td align="center" style="border-radius: 6px;color:#FFFFFF"> Trân trọng! </td>
                        </tr>
                      </table>
                      <!-- Header Button -->
                    </td>
